...
<template>
  <div>
    <img src="/todo.jpg" alt="Todo Photo" width="600px" />
    <p>
      Photo by
      <a
      ...
      on
      <a
        href="https://unsplash.com/photos/RLw-UC03Gwc?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"
        >Unsplash</a
      >
    </p>
    <h1>Hello world!</h1>
